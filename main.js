  ...
  repos.forEach(r => {
    ...
    el.innerHTML = `
          ...
          <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            <div class="actions">
              <a class="btn" href="${r.html_url}" target="_blank" rel="noopener"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" alt="GitHub" width="24" height="24" style="filter: brightness(0) invert(1);"/></a>
